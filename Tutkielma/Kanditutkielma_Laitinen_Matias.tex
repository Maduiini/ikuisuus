...
when prompted to take a course of action by a computer or automated aid. 
...
to catch inconsistencies or mistakes in task performance.
...
begun surfacing recently as by-products of automated systems. 

The implementation of automated aids in the aircraft cockpit, then, carries the
...
has only begun to be empirically explored. 
...
\section{TODO Huomiokyvyn keskittyminen (Attentional tunneling)}
