...
\caption{\itshape Rockwell Collins Flight Dynamics -heijastusnäyttö (Royal Australian Air Force TODO).}
\label{F:Rockwell Collins Flight Dynamics -heijastusnäyttö}
\end{figure}
...
Pelkkä EVS-järjestelmien käyttö ilman karttaa ei merkittävästi paranna toimintaa maassa. Myös ohjaajat arvioivat AMM -karttojen olevan olennaisessa osassa maatoimintaa ja yhdessä EVS sekä AMM toivat huomattavia etuja. Toiminta olisi näin mahdollista entistä huonomman näkyvyyden olosuhteissa kentillä, joilla on vain vähän tai ei lainkaan rullausta avustavia järjestelmiä käytössä. \citep{prinzelym2013}.
...
\caption{\itshape Yhdistetty SVS/EVS heijastusnäytöllä (TODO).}
\label{F:Yhdistetty SVS/EVS heijastusnäytöllä}
\end{figure}
