...
\tiivistelma{
Tässä tutkielmassa käsitellään keinonäkö- ja parannellun näön järjestelmien käyttöönottoa uuden sukupolven ilmailussa. Ensiksi esitellään erilaisia näyttölaitteita, jonka jälkeen perehdytään lennon näkyvyysolosuhteisiin ja ohjaajan tilannetietoisuuteen. Tutkielmassa käsitellään lisäksi yleisiä kognitiivisia haasteita, joita järjestelmien käytöstä voi aiheutua. Lopuksi kootaan yhteen järjestelmien hyödyt ja haitat sekä pohditaan mahdollista lisätutkimuksen tarvetta tulevaisuudessa.
}

\abstract{
This thesis discusses the implementation of synthetic and enhanced vision systems in next generation aviation. At first different display concepts are presented, after which the thesis introduces visibility conditions and situational awareneness of the pilot. In addition, cognitive challenges that could emerge when using these systems are discussed. Finally pros and cons of the EVS and SVS systems are collected and the possible need for further research is examined.
}
