...
\keywords{TODO}
\tiivistelma{
Tässä tutkielmassa käsitellään keinonäkö- ja parannellun näön järjestelmien käyttöönottoa uuden sukupolven ilmailussa. Ensiksi esitellään erilaisia näyttölaitteita, jonka jälkeen perehdytään lennon näkyvyysolosuhteisiin ja ohjaajan tilannetietoisuuteen. Tutkielmassa käsitellään lisäksi yleisiä kognitiivisia haasteita, joita järjestelmien käytöstä voi aiheutua. Lopuksi pohditaan, miten keinonäkö- ja parannellun näön järjestelmien käyttöönotto olisi mahdollista ja millä alueilla tarvitaan selvästi eniten lisätutkimusta.
}
